package kr.ac.kpu.game.s2018182039.pairgame;
...
public class MainActivity extends AppCompatActivity {
    ...
    private  int[] cards = {
            R.mipmap.arcana_chariot,  R.mipmap.arcana_chariot,  R.mipmap.arcana_emperor,  R.mipmap.arcana_emperor,
            R.mipmap.arcana_empress,  R.mipmap.arcana_empress,  R.mipmap.arcana_hermit,  R.mipmap.arcana_hermit,
            R.mipmap.arcana_justice,  R.mipmap.arcana_justice,  R.mipmap.arcana_lover,  R.mipmap.arcana_lover,
            R.mipmap.arcana_magician,  R.mipmap.arcana_magician,  R.mipmap.arcana_priestess,  R.mipmap.arcana_priestess,
            R.mipmap.arcana_strength,  R.mipmap.arcana_strength,  R.mipmap.arcana_judgement,  R.mipmap.arcana_judgement
    };
    ...
    public void onBtnCard(View view) {
        ...
        int prevCard = 0;
        if (prevButton != null) {
            prevButton.setImageResource(R.mipmap.arcana_back);
    ...
    private void startGame() {
        ...
        for (int i = 0; i < buttonIds.length; i++) {
            ...
            b.setImageResource(R.mipmap.arcana_back);
        }
        prevButton = null;
